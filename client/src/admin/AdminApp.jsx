...
const MARKETING_SKILLS = [
  ...
  { id: 'copy',      icon: '✍️', name: 'Copy & Messaging', desc: 'Taglines, landing page copy, value props',       prompts: ['Write 10 headline variations for the DrinkedInn homepage. Current: "Stories start here." Lead with people, moments and places — never alcohol.','Write the hero section copy for drinkedinn.com — include headline, subheadline, and CTA','Create 5 value proposition statements for DrinkedInn targeting: (1) people who host, (2) people who travel, (3) people building a taste of their own','Write an "About Us" page for DrinkedInn that feels authentic, not corporate','Rewrite the sign-up CTA to maximise conversions. Current CTA: "Pull Up a Chair"'] },
