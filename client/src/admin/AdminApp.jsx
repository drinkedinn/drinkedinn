...
const MARKETING_SKILLS = [
  { id: 'social',    icon: '📲', name: 'Social Content',   desc: 'Viral posts for Instagram, LinkedIn & TikTok', prompts: ['Write 5 viral Instagram captions for DrinkedInn that will drive sign-ups from whisky enthusiasts','Create a LinkedIn post thread about drink culture that showcases DrinkedInn features','Write a TikTok video hook script (first 3 seconds) for DrinkedInn targeting millennials who love craft beer','Generate a week-long content calendar for DrinkedInn social accounts','Write 10 tweet ideas for the @DrinkedInn account that would get high engagement'] },
